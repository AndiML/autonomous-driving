...
from autonomous_driving.commands import get_command_descriptors, get_command
...
class Application:
    ...
    def parse_command_line_arguments(self) -> argparse.Namespace:
        ...
        argument_parser = argparse.ArgumentParser(
            prog='autonomous_driving',
            description='A command line tool for experiments for Autonomous Driving.',
            add_help=False
        )
        ...
        argument_parser.add_argument(
            ...
            '--version',
            action='version',
            version=f'Autonomous Driving Experiments {__version__}',
